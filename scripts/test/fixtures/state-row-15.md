<!-- selftest: judge=5=false,8=false,10=false,11b=false rows=14,15 rc=0 -->
# STATE - next.sh fixture: row 15 - the loop is over and the black-box is stale
...
battery:                   green
blackbox:                  stale (an event changed since it ran)
